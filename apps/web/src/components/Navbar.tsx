  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-[#f4f7f3]/95 backdrop-blur-md border-b border-[#18241b]/10 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-15 flex items-center justify-between gap-4">
        ...
        {/* Right Column: GitHub Star, CTA Actions & Mobile Hamburger */}
        <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
          {/* GitHub Star Button */}
          <a
            href="https://github.com/divyesh123-jain/Vizora"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white border border-[#18241b]/15 hover:border-[#18241b] text-[#18241b] text-xs font-mono font-semibold shadow-xs hover:shadow-sm transition-all duration-150 hover:-translate-y-0.5 group"
            title="Star Vizora on GitHub"
          >
            {/* GitHub Octocat Icon */}
            <svg className="w-4 h-4 text-[#18241b] group-hover:text-[#c2872e] transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Star Icon */}
            <svg className="w-3.5 h-3.5 text-[#c2872e] fill-current" viewBox="0 0 24 24">
        ...
        <div className="md:hidden border-t border-[#18241b]/10 bg-[#f4f7f3] px-4 py-4 space-y-2 shadow-lg animate-in fade-in slide-in-from-top duration-200">
          ...
          <div className="pt-2 border-t border-[#18241b]/10 flex flex-col gap-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full py-2 rounded-lg bg-white border border-[#18241b]/15 text-[#18241b] text-xs font-mono flex items-center justify-center gap-2 font-semibold shadow-xs"
            >
